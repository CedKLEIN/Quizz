...
public class NodeBuilderServiceTests
{
    ...
    public async Task Build()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(
                rootNode.Children[0].Children[0].Children[0].Label,
                Is.EqualTo("Toutes les capitales")
            );
            Assert.That(
                rootNode.Children[0].Children[0].Children[0].Type,
                Is.EqualTo(PageType.Quiz)
            );
            Assert.That(
                rootNode.Children[0].Children[0].Children[0].Children,
                Has.Count.EqualTo(3)
            );
            Assert.That(
                rootNode.Children[0].Children[0].Children[0].Children[0].Question,
                Is.EqualTo("Afghanistan")
            );
            Assert.That(
                rootNode.Children[0].Children[0].Children[0].Children[0].Answer,
                Is.EqualTo("Kaboul")
            );
            Assert.That(
                rootNode.Children[0].Children[0].Children[0].Children[0].Type,
                Is.EqualTo(PageType.Question)
            );
            Assert.That(
                rootNode.Children[0].Children[0].Children[0].Children[0].Get<string>("continent"),
                Is.EqualTo("Asie")
            );
            Assert.That(
                rootNode.Children[0].Children[0].Children[0].Children[1].Question,
                Is.EqualTo("Afrique du Sud")
            );
            Assert.That(
                rootNode.Children[0].Children[0].Children[0].Children[1].Answer,
                Is.EqualTo("Pretoria")
            );
            Assert.That(
                rootNode.Children[0].Children[0].Children[0].Children[1].Type,
                Is.EqualTo(PageType.Question)
            );
            Assert.That(
                rootNode.Children[0].Children[0].Children[0].Children[1].Get<string>("continent"),
                Is.EqualTo("Afrique")
            );
            Assert.That(
                rootNode.Children[0].Children[0].Children[0].Children[2].Question,
                Is.EqualTo("Albanie")
            );
            Assert.That(
                rootNode.Children[0].Children[0].Children[0].Children[2].Answer,
                Is.EqualTo("Tirana")
            );
            Assert.That(
                rootNode.Children[0].Children[0].Children[0].Children[2].Type,
                Is.EqualTo(PageType.Question)
            );
            Assert.That(
                rootNode.Children[0].Children[0].Children[0].Children[2].Get<string>("continent"),
                Is.EqualTo("Europe")
            );
